...
CREATE TABLE party_classification (
  PARTY_CLASSIFICATION_ID varchar(40),
  CLASSIFICATION_TYPE_ENUM_ID varchar(40),
  PARENT_CLASSIFICATION_ID varchar(40),
  DESCRIPTION varchar(255),
  PRIMARY KEY (PARTY_CLASSIFICATION_ID),
  FOREIGN KEY (CLASSIFICATION_TYPE_ENUM_ID) REFERENCES enumeration(ENUM_ID)
);
...
-- Mantle Marketing entities

CREATE TABLE market_segment (
  MARKET_SEGMENT_ID varchar(40),
  MARKET_SEGMENT_TYPE_ENUM_ID varchar(40),
  TYPE_SEQUENCE_NUM decimal(20,0),
  PARENT_MARKET_SEGMENT_ID varchar(40),
  DESCRIPTION varchar(255),
  PRODUCT_STORE_ID varchar(40),
  OWNER_PARTY_ID varchar(40),
  PRIMARY KEY (MARKET_SEGMENT_ID),
  FOREIGN KEY (MARKET_SEGMENT_TYPE_ENUM_ID) REFERENCES enumeration(ENUM_ID),
  FOREIGN KEY (PARENT_MARKET_SEGMENT_ID) REFERENCES market_segment(MARKET_SEGMENT_ID),
  FOREIGN KEY (OWNER_PARTY_ID) REFERENCES party(PARTY_ID),
  FOREIGN KEY (PRODUCT_STORE_ID) REFERENCES product_store(PRODUCT_STORE_ID)
);

CREATE TABLE market_segment_party (
  MARKET_SEGMENT_ID varchar(40),
  PARTY_ID varchar(40),
  ROLE_TYPE_ID varchar(40),
  FROM_DATE datetime(3),
  THRU_DATE datetime(3),
  PRIMARY KEY (MARKET_SEGMENT_ID, PARTY_ID, ROLE_TYPE_ID, FROM_DATE),
  FOREIGN KEY (MARKET_SEGMENT_ID) REFERENCES market_segment(MARKET_SEGMENT_ID),
  FOREIGN KEY (PARTY_ID) REFERENCES party(PARTY_ID),
  FOREIGN KEY (ROLE_TYPE_ID) REFERENCES role_type(ROLE_TYPE_ID)
);
